...
const addTrialInfo = async ({stripe, subscription, fromPlan, toPlan}) => {
  if (fromPlan === "plan_GWEUqaZ2fT6emr" && toPlan === "plan_GGmZYYHK0DyAPm" && !subscription.metadata.has_had_trial) {
...
const paddleSubscribe = async ({client, plan, teamRef}) => {
